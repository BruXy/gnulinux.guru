...
1i\table, th { border-collapse: collapse;}
1i\td { border: 1px solid black; }
1i\.framed td, .framed th { border: 1px solid black; }
1i\table.framed { border: 1px solid black; border-collapse: collapse; text-align:center;}
1i\\</style>
...
s:\\bTABLEhead:<thead>:
s:\\eTABLEhead:<\/thead>:
s:\\bTABLE\[.*style=tt.*\]:<table style="font-family\: monospace;">:
s:\\bTABLE.*:<table>:
s:\\eTABLE.*:<\/table>:
s:\\bTR\(\[.*\]\)*:<tr>:g
s:\\eTR:<\/tr>:g
...
s:\\pyind *:␣␣␣␣:g      
s:\\bullet:●:g
s:\\framedTABLE:<table class="framed">:g
/\\cbf/s:<td>:<td style="text-align\:center">:g
s:{\\cbf\([^}]*\)}:<b>\1</b>:g
s:\\uv{\([^}]*\)}:‘\1’:g
